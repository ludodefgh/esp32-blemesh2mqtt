...
private:
    credential_encryption() = default;
    ~credential_encryption();

    // Disable copy
    credential_encryption(const credential_encryption &) = delete;
    credential_encryption &operator=(const credential_encryption &) = delete;
